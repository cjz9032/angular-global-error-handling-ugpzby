...
type ErrorStatusCode = ErrorCodeSucceedCode | ErrorCodeFailCode1 | ErrorCodeFailCode2 | ErrorCodePermissionErrorCode;
...
type CurrentModeStatusCode = CurrentModeSucceedDisableCode | CurrentModeSucceedEnableCode | CurrentModeFailErrorCode | CurrentModeFailPermissionErrorCode | CurrentModeFailSystemErrorCode;
