	...
	qas: QA[] = [
		{
			...
			description: `<div>
									...
									<div class="mb-5">
										...
										<span style="font-weight:bold">Backup</span>    &gt; <span style="font-weight:bold">Add a drive</span>  , and then choose an external drive or network location for your backups.
									</div>
									<div class="mb-5">
										<img src="./../../../../assets/images/qa/1.1.png"/>
									</div>
									<div class="mb-5">
										All set. Every hour, we'll back up everything in your user folder (C:\\Users\\username). To change which files get backed up or how often backups happen, go to
									...
									<div>
											 ...
											 <span style="font-weight:bold">Restore</span>, select <span style="font-weight:bold">Restore to</span>, and then choose a new location.</div>
												...
												<li style="padding:10px 0;">
													...
													<ol>
														...
														<li style="padding:5px 0;">
															...
															button just below the heading<span style="font-weight:bold;">  "Refresh your PC without affecting your files"</span> to start refreshing your Windows 10 PC.</div>
		...
		},
		{
			...
			Or, if you are using a mouse, point to the lower-right corner of the screen, and then click <strong>Search.</strong></li>
			...
			<li>If you are running a 64-bit version of Windows 8, <strong>64-bit Operating System</strong>
			 ...
			 <strong>32-bit Operating </strong>System is displayed in the System type field under the System heading.<br /> &nbsp;</li>
			</ol>
			...
			version of Windows 8,&nbsp;x86-based PC&nbsp;is displayed in the&nbsp;<strong>System type</strong>&nbsp;field under the&nbsp;Item&nbsp;heading. &nbsp;</li>
			</ol>
			<p>&nbsp;</p>`
		},
		{
			...
			screen that shows you what&rsquo;s draining your laptop&rsquo;s juice.
			 That means it&rsquo;ll tell you exactly what apps&ndash;both desktop and Windows 10 &ldquo;universal&rdquo; apps&ndash;are using too much power.</p>
			<h3 style="font-weight:bold;font-size:2.5rem;padding:10px 0">Affected Brands</h3>
			...
			traditional&nbsp;<strong>control panel&nbsp;</strong>view, this feature is located in the new&nbsp;<strong>&ldquo;Settings&rdquo;</strong>&nbsp;app</p>
			<p><br /> </p>
			...
			select&nbsp;<strong>&ldquo;System&rdquo;</strong>and then select&nbsp;<strong>&ldquo;Battery saver.&rdquo;<br /> <br /> </strong> <strong><br /> <br /> </strong></p>
			...
			<strong>Wi-Fi&rdquo;</strong>&nbsp;percentages. This shows how much battery power has been used by system processes, the display,</p>
			<p>6 The&nbsp;<strong>&ldquo;In use&rdquo;</strong>&nbsp;and&nbsp;<strong>&ldquo;Background&rdquo;</strong>
			&nbsp;options show how much power is used by applications while you&rsquo;re using them, compared to applications running in the background.</p>
			<p>7 If apps are using power in the background, you can click or tap the&nbsp;<strong>
			&ldquo;Change background app settings&rdquo;&nbsp;</strong>link and configure apps to not run in the background. This only works for universal Windows 10 apps.</p>
			<p>8 Scroll down further and you will see a list of applications, this is considered as the most useful section of this feature.
			 It will display a list of the apps have used battery power in that period, and show you what percentage of your battery power each app has used</p>
...
<p>&nbsp;</p>`
		},
		{
			...
			on the manufacturer's website. Support for this feature depends on the hardware, the driver that's installed, and how the device was set up by the manufacturer.&nbsp;</p>
			<p>&nbsp;</p>
		...
		},
		{
			...
			Then select&nbsp;<strong>Settings</strong>&nbsp;&nbsp;and turn on&nbsp;<strong>Let Cortana respond to "Hey Cortana."</strong></p>
