...
describe('GamingAdvancedOCService', () => {
    ...
    describe('isShellAvailable is false: ', () => {
        ...
        it('gamingAdvancedOCService.setAdvancedOCInfo should return undefined', () => {
            ...
            expect(gamingAdvancedOCService.setAdvancedOCInfo(gamingAdvancedOCService.getAdvancedOCInfo())).toBeUndefined();
        })
	})
	
    describe('isShellAvailable is true: ', () => {
        let advancedOCInfo:any = {
            cpuParameterList: [{ tuneId: 116, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1' },{ tuneId: 117, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1'}],
            gpuParameterList: [{ "tuneId":0,"defaultValue":"100","OCValue":"100","minValue":"200","maxValue":"300","stepValue":"1"},{"tuneId":1,"defaultValue":"100","OCValue":"100","minValue":"200","maxValue":"300","stepValue":"1"}]
        };
        beforeEach( () => {
            const spy = jasmine.createSpyObj('VantageService', ['getGamingAdvancedOC']);
            let spyValue =  {
        ...
        it('gamingAdvancedOCService.setAdvancedOCInfo should return ture',async() => {
			gamingAdvancedOCService.setAdvancedOCInfo(gamingAdvancedOCService.getAdvancedOCInfo()).then( res => {
