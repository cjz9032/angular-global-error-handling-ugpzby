...
export class ModalScheduleNewScanComponent implements OnInit, OnChanges {
	...
	public ampm: string =
		this.translate.instant('hardwareScan.am') +
		' / ' +
		this.translate.instant('hardwareScan.pm');
	public delete: string = this.translate.instant('hardwareScan.scheduledScan.delete');
	public warning: string = this.translate.instant(
		'hardwareScan.scheduledScan.warningBatterySaver'
	);
	...
	constructor(public dialogRef: MatDialogRef<ModalScheduleNewScanComponent>, private translate: TranslateService) {
		...
		this.optionsInterval = [
			{ name: this.translate.instant('hardwareScan.scheduledScan.onlyOnce'), id: 1 },
			{ name: this.translate.instant('hardwareScan.scheduledScan.eachDay'), id: 2 },
			{ name: this.translate.instant('hardwareScan.scheduledScan.eachWeek'), id: 3 },
			{ name: this.translate.instant('hardwareScan.scheduledScan.eachMonth'), id: 4 },
		];
	...
	public buildScanOptions() {
		...
		if (
			typeof this.timeScan !== 'undefined' &&
			typeof this.intervalOption !== 'undefined' &&
	...
	public onNewScanScheduling(): void {
		...
		this.scheduleNewScanButtonText = this.translate.instant(
			'hardwareScan.scheduledScan.scanScheduled'
		);
