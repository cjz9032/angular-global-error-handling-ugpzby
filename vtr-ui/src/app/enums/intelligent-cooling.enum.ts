...
export class IntelligentCoolingModes {
    public static Cool: IntelligentCoolingMode = { type : ICModes.Cool, status: true,  ideapadType4: "MMC_Auto", ideapadType3: "MMC_Cool"};
	...
	public static Error: IntelligentCoolingMode = { type:ICModes.Error, status: false, ideapadType4: "", ideapadType3: "MMC_Auto"};
