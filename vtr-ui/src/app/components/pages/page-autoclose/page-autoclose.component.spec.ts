...
describe('PageAutocloseComponent', () => {
    ...
    describe('quick setting toolbar & toast event', () => {
        ...
        const modalGamingPromptComponentServiceSpy = {
            open: (arg1, arg2) => {return modalGamingPromptCompoentMock}
        };
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                declarations: [PageAutocloseComponent, UiToggleStubComponent, ModalGamingPromptMockComponent, mockPipe({ name: 'translate' })],
        ...
        describe('openTargetModal Modal actions', () => {
            it('openTargetModal', fakeAsync(() => {
                gamingAutoCloseServiceSpy.setNeedToAskStatusCache = () => { return Promise.resolve(true)};
                ...
                component.isModalShowing = false;
                gamingAutoCloseServiceSpy.getNeedToAskStatusCache = () => { return true;};
                ...
                component.isModalShowing = false;
                gamingAutoCloseServiceSpy.getNeedToAskStatusCache = () => { return false;};
                ...
                component.isModalShowing = false;
                gamingAutoCloseServiceSpy.getNeedToAskStatusCache = () => { return 'undefined';};
                component.openTargetModal();
                tick(50);
                expect(component.needToAsk).toBe(false);
            ...
            it('toggleAutoClose', fakeAsync(() => {
                gamingAutoCloseServiceSpy.setAutoCloseStatus.and.returnValue(Promise.resolve(false));
            ...
            it('getautoclosestatus', async () => {
                gamingAutoCloseServiceSpy.getAutoCloseStatus.and.returnValue(Promise.reject('reject test'));
