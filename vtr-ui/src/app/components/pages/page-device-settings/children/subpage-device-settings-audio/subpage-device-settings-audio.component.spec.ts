...
describe('SubpageDeviceSettingsAudioComponent', () => {
    ...
    describe(':', () => {
        ...
        it('startMonitorHandler should call', () => {
            const { fixture, component } = setup();
            component.isDTmachine = false;
            component.microOptimizeModeResponse = microOptimizeModeResponse;
            component.microphoneProperties.currentMode = 'data'
            component.startMonitorHandler(microphoneProperties);
            expect(component.microOptimizeModeResponse.current).toBe('data');
            // expect(component.startMonitorHandler).toHaveBeenCalled()
        });

        it('startMonitorHandler should call -else case', () => {
            const { fixture, component } = setup();
            component.isDTmachine = false;
            component.microOptimizeModeResponse = microOptimizeModeResponse;
            component.microphoneProperties.currentMode = ''
            component.startMonitorHandler(microphoneProperties);
            expect(component.microOptimizeModeResponse.current).toBeTruthy();
            // expect(component.startMonitorHandler).toHaveBeenCalled()
        });
