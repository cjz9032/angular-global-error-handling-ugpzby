			...
			if (this.audioService.isShellAvailable) {
				this.audioService.getSupportedModes()
					.then((response: MicrophoneOptimizeModes) => {
						...
						this.logger.error('getSupportedModes', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.setMicrophoneOpitimaztion(this.microOptimizeModeResponse.current)
					.then((value) => {
						...
						this.logger.error('onOptimizeModesRadioChange', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.setDolbyOnOff(event.switchValue)
					.then((value) => {
						...
						this.logger.error('onAutomaticDolbyAudioToggleOnOff', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.getDolbyFeatureStatus()
					.then((dolbyFeature: FeatureStatus) => {
						...
						this.logger.error('getDolbyFeatureStatus', error);
						this.autoDolbyFeatureLoader = false;
						this.autoDolbyFeatureStatus.available = false;
					});
			}
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.getDolbyMode()
					.then((response: DolbyModeResponse) => {
						...
						this.logger.error('getDolbyModesStatus', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.startMonitorForDolby(this.startMonitorHandlerForDolby.bind(this))
					.then((value: boolean) => {
						...
						this.logger.error('startMonitorForDolby', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.stopMonitorForDolby()
					.then((value: boolean) => {
						...
						this.logger.error('stopMonitorForDolby', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.setDolbyMode(this.dolbyModeResponse.currentMode)
					.then((value) => {
						...
						this.logger.error('onDolbySeetingRadioChange', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.setMicrophoneAutoOptimization(event.switchValue)
					.then((value) => {
						...
						this.logger.error('onToggleOfMicrophoneAutoOptimization', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.setMicrophoneVolume(volume)
					.then((value) => {
						...
						this.logger.error('setVolume', error);
					});
			}
		} catch (error) {
			...
			if (this.dashboardService.isShellAvailable) {
				this.dashboardService.setMicrophoneStatus(event.switchValue)
					.then((value: boolean) => {
						...
						this.logger.error('onToggleOfMicrophone', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.setSuppressKeyboardNoise(event.switchValue)
					.then((value: boolean) => {
						...
						this.logger.error('onToggleOfSuppressKbdNoise', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.setMicrophoneAEC(event.switchValue)
					.then((value: boolean) => {
						...
						this.logger.error('setMicrophoneAEC', error);
					});
			}
		} catch (error) {
			...
			if (this.audioService.isShellAvailable) {
				this.audioService.stopMicrophoneMonitor()
					.then((value: boolean) => {
						...
						this.logger.error('stopMonitor', error);
					});
			}
		} catch (error) {
