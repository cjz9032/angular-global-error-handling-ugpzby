...
import {
	EventTypes, ConnectedHomeSecurityDemo, PluginMissingError, LocationPermissionOffError, CHSAccountState, WifiSecurity
...
import {
	HomeSecurityAccount
} from 'src/app/data-models/home-security-demo/home-security-account.model';
import {
	HomeSecurityPageStatus
} from 'src/app/data-models/home-security-demo/home-security-page-status.model';
import { TranslateService } from '@ngx-translate/core';
import { NgbModal, NgbModalRef } from '@ng-bootstrap/ng-bootstrap';
import { ModalChsWelcomeContainerDemoComponent } from '../page-connected-home-security-demo/component/modal-chs-welcome-container/modal-chs-welcome-container.component';
import { CommonService } from 'src/app/services/common/common.service';
import { DialogService } from 'src/app/services/dialog-demo/dialog.service';
...
import { HomeSecurityWelcome } from 'src/app/data-models/home-security-demo/home-security-welcome.model';
import { AppNotification } from 'src/app/data-models/common/app-notification.model';
import { HomeSecurityAllDevice } from 'src/app/data-models/home-security-demo/home-security-overview-allDevice.model';
import { HomeSecurityOverviewMyDevice } from 'src/app/data-models/home-security-demo/home-security-overview-my-device.model';
import { HomeSecurityNotifications } from 'src/app/data-models/home-security-demo/home-security-notifications.model';
import { HomeSecurityCommon } from 'src/app/data-models/home-security-demo/home-security-common.model';
...
@Component({
	selector: 'vtr-page-connected-home-security-demo',
	templateUrl: './page-connected-home-security.component.html',
	styleUrls: ['./page-connected-home-security.component.scss']
})
export class PageConnectedHomeSecurityDemoComponent implements OnInit, OnDestroy, AfterViewInit {
	...
	ngOnInit() {
		...
		this.chs.on(EventTypes.chsEvent, (chs) => {
			if (chs && chs.overview) {
	...
	openWelcomeModal(showWelcome): NgbModalRef {
		if (this.commonService.getSessionStorageValue(SessionStorageKey.HomeProtectionInCHSPage)) {
			...
			const welcomeModal = this.modalService.open(ModalChsWelcomeContainerDemoComponent, {
				backdrop: 'static',
				size: 'lg',
				centered: true,
