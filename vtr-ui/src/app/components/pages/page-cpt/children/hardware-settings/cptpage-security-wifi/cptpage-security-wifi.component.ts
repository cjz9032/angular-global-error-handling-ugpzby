...
@Component({
  selector: 'vtr-cptpage-security-wifi',
  templateUrl: './cptpage-security-wifi.component.html',
  styleUrls: ['./cptpage-security-wifi.component.scss']
})
export class CptpageSecurityWifiComponent implements OnInit, OnDestroy {
  title = 'WiFi Security';
