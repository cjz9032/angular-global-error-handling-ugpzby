			...
			if (this.displayService.isShellAvailable) {
				this.displayService.getOLEDPowerControlCapability()
					.then((result: boolean) => {
						...
						this.logger.error('OLED-Power-Settings : getOLEDPowerControlCapability', error);
			...
			if (this.displayService.isShellAvailable && this.hasOLEDPowerControlCapability) {
				this.displayService.getTaskbarDimmerSetting()
					.then((result: any) => {
						...
						this.logger.error('OLED-Power-Settings : getTaskbarDimmerSetting error', error);
			...
			if (this.displayService.isShellAvailable && this.hasOLEDPowerControlCapability) {
				this.displayService.getBackgroundDimmerSetting()
					.then((result: any) => {
						...
						this.logger.error('OLED-Power-Settings : getBackgroundDimmerSetting error', error);
			...
			if (this.displayService.isShellAvailable && this.hasOLEDPowerControlCapability) {
				this.displayService.getDisplayDimmerSetting()
					.then((result: any) => {
						...
						this.logger.error('OLED-Power-Settings : getDisplayDimmerSetting error', error);
			...
			if (this.displayService.isShellAvailable && this.hasOLEDPowerControlCapability) {
				this.displayService
					.setTaskbarDimmerSetting(String(value)).then((result: boolean) => {
						...
						this.logger.error('OLED-Power-Settings : setTaskbarDimmerSetting error ', error);
			...
			if (this.displayService.isShellAvailable && this.hasOLEDPowerControlCapability) {
				this.displayService
					.setDisplayDimmerSetting(String(value)).then((result: boolean) => {
						...
						this.logger.error('OLED-Power-Settings : setDisplayDimmerSetting error', error);
