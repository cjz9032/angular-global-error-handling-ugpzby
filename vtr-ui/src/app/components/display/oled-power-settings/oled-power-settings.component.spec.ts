...
describe('OledPowerSettingsComponent', () => {
	...
	it('should call getTaskbarDimmerSetting - inner catch block', () => {
		displayService.isShellAvailable = true;
		const spy = spyOn(displayService, 'getTaskbarDimmerSetting').and.returnValue(
			Promise.reject()
		);
	...
	it('should call getBackgroundDimmerSetting - inner catch block', () => {
		displayService.isShellAvailable = true;
		const spy = spyOn(displayService, 'getBackgroundDimmerSetting').and.returnValue(
			Promise.reject()
		);
	...
	it('should call getDisplayDimmerSetting - inner catch block', () => {
		displayService.isShellAvailable = true;
		const spy = spyOn(displayService, 'getDisplayDimmerSetting').and.returnValue(
			Promise.reject()
		);
