...
const autoCloseServiceMock = jasmine.createSpyObj('GamingAutoCloseService', ['isShellAvailable', 'gamingAutoClose', 'getAppsAutoCloseRunningList', 'addAppsAutoCloseList', 'delAppsAutoCloseList']);
const networkBoostServiceMock = jasmine.createSpyObj('NetworkBoostService', ['isShellAvailable', 'setNetworkBoostStatus', 'getNetUsingProcesses', 'addProcessToNetworkBoost', 'deleteProcessInNetBoost']);

const cmsServiceMock = jasmine.createSpyObj('CMSService', ['fetchCMSContent', 'getOneCMSContent']);
const commonServiceMock = jasmine.createSpyObj('CommonService', ['isShellAvailable', 'notification', 'getShellVersion', 'compareVersion']);
...
const autoCloseAppList = {
    processList: [
        ...
        { processDescription: 'Microsoft.Windows.ShellExperienceHost', iconName: 'ms-appdata:///local/icon/3862fc8e419fa507.png' },
        ...
        { processDescription: 'microsoft.windowscommunicationsapps', iconName: 'ms-appdata:///local/icon/7b2ca07c9a67cc86.png' },
        { processDescription: 'windows.immersivecontrolpanel', iconName: 'ms-appdata:///local/icon/4a4341b5d5250f32.png' }
    ]
};
...
describe('ModalGamingRunningAppListComponent', () => {
    ...
    it('should isLastCheckedApp', async () => {
        autoCloseServiceMock.getAppsAutoCloseRunningList.and.returnValue(Promise.resolve(autoCloseAppList));
        component.runningList = autoCloseAppList.processList;
