...
describe('ModalGamingAdvancedOCComponent : ', () => {
    ...
    describe('check setRangeValue : ', () => {
        ...
        it('setRangeValue cpuParameterList pairwiseAssociation', async() => {
            ...
            for(let i=0; i<component.advancedOCInfo.cpuParameterList.length; i++) {
                component.setRangeValue(40,i,'cpuParameterList',component.advancedOCInfo.cpuParameterList[i].tuneId ,false);
                expect(arr1.includes(component.advancedOCInfo.cpuParameterList[i].tuneId)).toBe(false);
            ...
            for(let i=0; i<component.advancedOCInfo.cpuParameterList.length; i++) {
                component.setRangeValue(40,i,'cpuParameterList',component.advancedOCInfo.cpuParameterList[i].tuneId ,false);
                expect(arr1.includes(component.advancedOCInfo.cpuParameterList[i].tuneId)).toBe(true);
                expect(component.advancedOCInfo.cpuParameterList[i].OCValue).toBe(40);
        ...
        it('setRangeValue cpuParameterList multipleAssociations', async() => {
            ...
            for(let i=0; i<component.advancedOCInfo.cpuParameterList.length; i++) {
                component.setRangeValue(40,i,'cpuParameterList',component.advancedOCInfo.cpuParameterList[i].tuneId ,false);
                expect(arr2.includes(component.advancedOCInfo.cpuParameterList[i].tuneId)).toBe(false);
                expect(component.advancedOCInfo.cpuParameterList[i].OCValue).toBe(40);
            }
            for(let i=0; i<component.advancedOCInfo.cpuParameterList.length; i++) {
                component.setRangeValue([40,1],i,'cpuParameterList',component.advancedOCInfo.cpuParameterList[i].tuneId ,true);
                expect(arr2.includes(component.advancedOCInfo.cpuParameterList[i].tuneId)).toBe(false);
                expect(component.advancedOCInfo.cpuParameterList[i].OCValue).toBe(40);
            }

            component.advancedOCInfo.cpuParameterList = [
                { tuneId: 29, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1' },
                { tuneId: 30, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1'},
                { tuneId: 31, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1' },
                { tuneId: 32, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1'},
                { tuneId: 42, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1'},
                { tuneId: 43, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1' },
                { tuneId: 96, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1'},
                { tuneId: 97, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1'},
                { tuneId: 107, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1'},
                { tuneId: 108, OCValue: '41', defaultValue:'40', minValue: '28', maxValue: '80', stepValue: '1'},
            ];
            for(let i=0; i<component.advancedOCInfo.cpuParameterList.length; i++) {
                component.setRangeValue(40,i,'cpuParameterList',component.advancedOCInfo.cpuParameterList[i].tuneId ,false);
                expect(arr2.includes(component.advancedOCInfo.cpuParameterList[i].tuneId)).toBe(true);
                expect(component.advancedOCInfo.cpuParameterList[i].OCValue).toBe(40);
            }
            for(let i=0; i<component.advancedOCInfo.cpuParameterList.length; i++) {
                component.setRangeValue(45,i,'cpuParameterList',component.advancedOCInfo.cpuParameterList[i].tuneId ,false);
                expect(arr2.includes(component.advancedOCInfo.cpuParameterList[i].tuneId)).toBe(true);
            ...
            for(let i=0; i<component.advancedOCInfo.cpuParameterList.length; i++) {
                component.setRangeValue([45,2],i,'cpuParameterList',component.advancedOCInfo.cpuParameterList[i].tuneId ,true);
                expect(arr2.includes(component.advancedOCInfo.cpuParameterList[i].tuneId)).toBe(true);
                expect(component.advancedOCInfo.cpuParameterList[i].OCValue).toBe(45);
            }
        });
    ...
    describe('check multipleAssociations : ', () => {
        ...
        it('multipleAssociations add', async(() => {
            ...
            for(let i=0; i<component.advancedOCInfo.cpuParameterList.length; i++) {
                component.multipleAssociations (arr2, component.advancedOCInfo.cpuParameterList[i].tuneId, 45, 2,2);
                for (let j = 0; j<=i; j++) {
        ...
        it('multipleAssociations reduce', async(() => {
            ...
            for(let i=0; i<component.advancedOCInfo.cpuParameterList.length; i++) {
                component.multipleAssociations (arr2, component.advancedOCInfo.cpuParameterList[i].tuneId, 39, 1,1);
