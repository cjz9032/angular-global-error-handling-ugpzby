...
fdescribe("UiSmartPerformanceScanningComponent", () => {
	...
	it("should call updateScanResponse -category - 100 & subcategory -101", async(() => {
        ...
        // component.scanData.status.category = event.payload.status.category;
        // component.scanData.status.subcategory = event.payload.status.subcategory
        console.log('zakir1', event);
        component.spSubCategoryenum.HUNDEREAD;
        component.updateScanResponse(event);
        console.log('zakir2',component.activegroup);
        console.log('zakir3',component.scanData);
